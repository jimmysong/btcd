...
func TestSignatureSerialize(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			&Signature{
				R: new(nfieldVal).SetHex("a196ed0e7ebcbe7b63fe1d8eecbdbde03a67ceba4fc8f6482bdcb9606a911404"),
				S: new(nfieldVal).SetHex("971729c7fa944b465b35250c6570a2f31acbb14b13d1565fab7330dcb2b3dfb1"),
			},
			[]byte{
